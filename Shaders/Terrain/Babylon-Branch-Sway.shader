...
Shader "Babylon/Terrain/TreeBranch"
{
    Properties
    {
        ...
        // this.addVector4Uniform("g_windDirection", new BABYLON.Vector4(1.0, 0.0, 0.0, 0.0));
        
        // g_windTime("Wind Time", Float) = 0.0
        g_windSpeed("Wind Speed", Float) = 1.0
        g_windAmount("Wind Amount", Float) = 0.5
        g_windStrength("Wind Strength", Float) = 0.5
        g_windDirection("Wind Direction", Vector) = (1.0, 0.0, 0.0, 0.0)

        // Babylon Cubemap Options
        _ReflectColor("Reflection Color", Color) = (1,1,1,0.5)
        _Cube("Reflection Cubemap", Cube) = "_Skybox" {}
        _BoxSize("Reflection Box Size", Vector) = (0,0,0,0)
        _BoxOffset("Reflection Box Offset", Vector) = (0,0,0,0)
        ...
        _DetailBlendLevel("Detail Blend Level", Range(0.0, 1.0)) = 0.75
    ...
    Shader: "Standard"
    Material: "TOOLKIT.TreeBranchMaterial"
