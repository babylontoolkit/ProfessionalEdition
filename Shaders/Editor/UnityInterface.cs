...
namespace UnityEditor
{
    ...
    {
        public static string SystemPredefinedPropertyNames = "_Mode, _Cutoff, _Color, _MainTex, _Glossiness, _SpecColor, _SpecBaseColor, _SpecGlossMap, _GlossMapScale, _Metallic, _MetallicGlossMap, _EmissionIllumination, _EnableEmission, _EmissionColor, _EmissionMap, _OcclusionMap, _OcclusionStrength, _BumpMap, _BumpScale, _GlossyReflections, _SmoothnessTextureChannel, _SpecularHighlights, _Parallax, _ParallaxMap, _DetailMask, _DetailAlbedoMapScale, _DetailAlbedoMap, _DetailNormalMapScale, _DetailNormalMap, _UVSec, _SrcBlend, _DstBlend, _ZWrite, _MaxLightCount, _AmbientColor, _EnableLighting, _UnlitMaterial, _FreezeMaterial, _UseWireframe, _BackFaceCulling, _LightmapIntensity, _DirectIntensity, _SpecularIntensity, _EmissiveIntensity, _EnvironmentIntensity, _ClearCoatIntensity, _WorkflowMode, _BaseMap, _BaseColor, _ReflectColor, _Cube, _BoxSize, _BoxOffset, _AlphaBlendMode, _IndexOfRefraction, _DetailBlendLevel, _DetailRoughnessLevel, _Surface, _Blend, _Cull, _AlphaClip, _ReceiveShadows, _QueueOffset, _EnvironmentReflections";
        ...
        private static class Styles
        {
            ...
            public static GUIContent clearCoatIntensityText = EditorGUIUtility.TrTextContent("Clear Coat Intensity", "Clear Coat Intensity");
            ...
            public static GUIContent reflectColorText = EditorGUIUtility.TrTextContent("Reflect Color", "Reflect Color");
            public static GUIContent cubeText = EditorGUIUtility.TrTextContent("Reflection Cubemap", "Reflection Cubemap");
            public static GUIContent boxSizeText = EditorGUIUtility.TrTextContent("Box Size", "Box Size");
            public static GUIContent boxOffsetText = EditorGUIUtility.TrTextContent("Box Offset", "Box Offset");
            public static GUIContent indexOfRefractionText = EditorGUIUtility.TrTextContent("Index Of Refraction", "Index Of Refraction");
            public static GUIContent detailBlendLevelText = EditorGUIUtility.TrTextContent("Detail Blend Level", "Detail Blend Level");
            public static GUIContent detailRoughnessLevelText = EditorGUIUtility.TrTextContent("Detail Roughness Level", "Detail Roughness Level");

            public static string primaryMapsText = "Main Maps";
            public static string secondaryMapsText = "Secondary Maps";
            public static string forwardText = "Forward Rendering Options";
            public static string renderingMode = "Rendering Mode";
            public static string rendererText = "Babylon Input Options";
            public static string exporterText = "Custom Input Options";
        ...
        MaterialProperty clearCoatIntensity = null;
        MaterialProperty specularBaseColor = null;
        MaterialProperty reflectColor;
        MaterialProperty cube;
        MaterialProperty boxSize;
        MaterialProperty boxOffset;
        MaterialProperty indexOfRefraction;
        MaterialProperty detailBlendLevel;
        MaterialProperty detailRoughnessLevel;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            clearCoatIntensity = FindProperty("_ClearCoatIntensity", props, false);
            specularBaseColor = FindProperty("_SpecBaseColor", props, false);
            reflectColor = FindProperty("_ReflectColor", props, false);
            cube = FindProperty("_Cube", props, false);
            boxSize = FindProperty("_BoxSize", props, false);
            boxOffset = FindProperty("_BoxOffset", props, false);
            indexOfRefraction = FindProperty("_IndexOfRefraction", props, false);
            detailBlendLevel = FindProperty("_DetailBlendLevel", props, false);
            detailRoughnessLevel = FindProperty("_DetailRoughnessLevel", props, false);
        }
        ...
        public void ShaderPropertiesGUI(Material material, MaterialEditor materialEditor, MaterialProperty[] props)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                if (clearCoatIntensity != null)
                    m_MaterialEditor.ShaderProperty(clearCoatIntensity, Styles.clearCoatIntensityText);
                ...
                if (reflectColor != null)
                    m_MaterialEditor.ShaderProperty(reflectColor, Styles.reflectColorText);
                if (cube != null)
                    m_MaterialEditor.ShaderProperty(cube, Styles.cubeText);
                if (boxSize != null)
                    m_MaterialEditor.ShaderProperty(boxSize, Styles.boxSizeText);
                if (boxOffset != null)
                    m_MaterialEditor.ShaderProperty(boxOffset, Styles.boxOffsetText);
                if (indexOfRefraction != null)
                    m_MaterialEditor.ShaderProperty(indexOfRefraction, Styles.indexOfRefractionText);
                if (detailBlendLevel != null)
                    m_MaterialEditor.ShaderProperty(detailBlendLevel, Styles.detailBlendLevelText);
                if (detailRoughnessLevel != null)
                    m_MaterialEditor.ShaderProperty(detailRoughnessLevel, Styles.detailRoughnessLevelText);
                CustomPropertiesGUI(materialEditor, props);
                // Use default labelWidth
                EditorGUIUtility.labelWidth = 0f;
            }
            if (EditorGUI.EndChangeCheck())
        ...
        public void CustomPropertiesGUI(MaterialEditor materialEditor, MaterialProperty[] props)
        {
