...
public class AI_CodeAssistant : EditorWindow
{
    ...
    public const string CODEWRX_AI_ASSISTANT = "https://github.com/codewrxai/ai-code-assistant-plugin";
    ...
    public const string DEFAULT_TRAINING_EXAMPLE = "A training example for converting Unity C# code to BabylonJS TypeScript code.";
    ...
    {
        CanvasTools.CanvasToolsExporter.Initialize();
        Application.OpenURL(AI_CodeAssistant.VSCODE_AI_EXTENSION);
    }
    ...
    public void OnGUI()
    {
        ...
        EditorGUI.BeginDisabledGroup(logicModel == OpenAILogicModel.gptX && this.selectMode == true);
            //if (logicModel == OpenAILogicModel.gptX)
            //{
                sourceControl = (OpenAISourceControl)EditorGUILayout.EnumPopup("SCM Control:", (OpenAISourceControl)sourceControl, GUILayout.ExpandWidth(true));
                EditorGUILayout.Space();
            //}
