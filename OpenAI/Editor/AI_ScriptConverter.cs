...
public class AI_ScriptConverter : EditorWindow
{
    ...
    public void OnGUI()
    {
        EditorGUI.BeginDisabledGroup(true);
            ...
            {
                fineTunedModel = EditorGUILayout.TextField("AI Logic Model:", fineTunedModel, GUILayout.ExpandWidth(true));
    ...
    private async void PostConvertWebRequest(string payload, string output)
    {
        ...
        try
        {
            string result = await AI_CodeAssistant.PostSafeWebRequestAsync(AI_CodeAssistant.API_ENDPOINT, this.openAIAPIKey, payload);
