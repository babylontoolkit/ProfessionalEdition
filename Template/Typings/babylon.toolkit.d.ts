...
declare namespace TOOLKIT {
    ...
    */
     ...
     */
        ...
        static InstantiateModelsFromContainer(container: BABYLON.AssetContainer, nameFunction?: (sourceName: string) => string, createInstances?: boolean, cloneMaterials?: boolean, filterPredicate?: any): BABYLON.TransformNode[];
        ...
        static BakeNavigationMesh(scene: BABYLON.Scene, meshes: BABYLON.Mesh[], properties: BABYLON.INavMeshParameters, debug?: boolean, color?: BABYLON.Color3, collisionMesh?: boolean): number;
        /** Load the recast navigation mesh binary data. (Navigation Helper) */
        static LoadNavigationMesh(scene: BABYLON.Scene, data: Uint8Array, debug?: boolean, color?: BABYLON.Color3, timeSteps?: number, collisionMesh?: boolean): number;
...
declare namespace TOOLKIT {
    ...
    class CharacterController extends TOOLKIT.ScriptComponent {
        ...
        /** Sets the character position and rotation to the specfied values. Aux is reset pre step option. */
...
declare namespace TOOLKIT {
    ...
    class RigidbodyPhysics extends TOOLKIT.ScriptComponent {
        ...
        protected static GetCachedPhysicsMeshShape(scene: BABYLON.Scene, entity: BABYLON.TransformNode, meshkey: string, friction: number, restitution: number, layer: number, filter: number): BABYLON.PhysicsShapeMesh;
        protected static GetCachedPhysicsConvexHullShape(scene: BABYLON.Scene, entity: BABYLON.TransformNode, meshkey: string, friction: number, restitution: number, layer: number, filter: number): BABYLON.PhysicsShapeConvexHull;
